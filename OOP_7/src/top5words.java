public class top5words {
    ...
    public int sortWords(){
        String tempWord;
        int tempAmount;
        if(this.fifthAmount > this.fourthAmount){
            if(this.fourthAmount > this.thirdAmount){
                if(this.thirdAmount > this.secondAmount){
                    if(this.secondAmount > this.firstAmount){
                        tempWord = this.secondPlace;
                        tempAmount = this.secondAmount;
                        this.secondPlace = this.firstPlace;
                        this.secondAmount = this.firstAmount;
                        this.firstPlace = tempWord;
                        this.firstAmount = tempAmount;
                    }
                }
